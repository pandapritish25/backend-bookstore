...
function BookModal({book, onclose}) {
    return(
        <div className="fixed bg-black/80 top-0 left-0 right-0 bottom-0 z-50 flex justify-center items-center">
            <div className="w-[600px] max-w-full h-[400px] bg-white rounded-2xl p-4 flex flex-col relative">
